...
LIB_FLAGS = -std=c++20 -I ./include -I $(OPENGL_INCLUDE) -I $(GLFW_INCLUDE) -c -L$(GLWF) -L$(OPENGL) -L$(GLM) -framework Cocoa -framework CoreFoundation -framework IOKit -framework CoreGraphics
LIB_LIBS = -l$(GLFW_LIB) -l$(OPENGL_LIB) -l$(GLM_LIB)
LIB_LINK = -dynamiclib -L$(GLFW) -L$(OPENGL) -L$(GLM) -framework Cocoa -framework CoreFoundation -framework IOKit -framework CoreGraphics -framework OpenGL
...
GLM = /opt/homebrew/Cellar/glm/1.0.1/lib
GLM_LIB = glm
